...
use crate::impressions::{Impressions, ImpressionsParam, CompetitionGeneratorParametrizedLogNormal, CompetitionGeneratorNone, FloorGeneratorFixed, FloorGeneratorLogNormal};
use crate::utils;
...
fn prepare_simulationconverge(mrg_boost_factor: f64) -> SimulationConverge {
    ...
    let seller_converge = simulation_converge.initial_seller_converges.seller_converges[0].as_any_mut().downcast_mut::<crate::sellers::SellerConvergeBoost>().unwrap();
